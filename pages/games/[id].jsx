        ...
        <Row xs="1" md="2" className="d-flex flex-row justify-content-center align-items-center">
          <Col className="d-flex flex-column">
            <div className={styles.desc + " p-4 "}>
              <ReactPlayer className={styles.reactPlayer} muted={true} url={games?.trailer} width="100%" height="100%" />
            </div>
          </Col>
          ...
          <Col className="d-flex flex-column mt-5">
            <div className={styles.lead + " w-100 p-6 d-flex flex-column text-center"}>
